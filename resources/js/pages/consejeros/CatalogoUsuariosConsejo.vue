                ...
                <table class="table">
                    <thead class="headers-table">
                        <tr>
                            ...
                            <th class="titulo-columna">Consejero</th>
    ...
    export default defineComponent({
        ...
        methods: {
            ...
            cancelarAgregarNuevoUsuario() {
                ...
                // this.usuario.rol = ''
                this.usuario.consejero_id = null
            ...
            EditarUsuario(usuario) {
                ...
                this.usuario.rol_id = 6
                this.usuario.consejero_id = usuario.consejero_id
            ...
            async getCatalogoUsuarios() {
                this.loading = true
                try {
                    let response = await axios.get('/api/catalogos/usuarios-consejeros')
                    if (response.status === 200) {
                        if (response.data.status === "ok") {
